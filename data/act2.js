...
window.DATA_ACT2 = {
  ...
  "scenes": {
    ...
    "talk_celeste": { "beats":[
      ...
      { "who":"celeste", "emote":"smile", "text":"오호호! 10년이나 돼서 기억이나 하겠어요? 얼굴도 가물가물해요!" },
    ...
    "oli_body": { "beats":[
      ...
      { "text":"올리다." },
      { "text":"쓰러진 자세가 어딘가 부자연스럽다. 손등이 위로 향해 있고, 발끝은 가지런하다. 어디선가 본 적이 있는 모양이다." },
    ...
    "reflect3": { "beats":[
      ...
      { "text":"올리 씨의 자세 — 손등이 위, 발끝이 가지런. 에드먼드 씨도, 같은 자세였다." },
      { "text":"서재의 그 책, 그림 속 자세와도 똑같다." },
      { "text":"…같은 자세가 되풀이되고 있다. 다락 벽을 채운, 그 청년들처럼." },
      { "text":"이건 우연이 아니다. 누군가가, 같은 방식을 — 반복하고 있다." },
